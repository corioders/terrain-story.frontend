<template>
	<p>Rozsypanka część 1 - 5 zasad dobrego życia.</p>
...
<script lang="ts">
	...
	import { matching1 as questions } from '@help/assets/questions';
	...
	export default defineComponent({
		...
		setup() {
			...
			return { questions, ...questionExecutor(() => store.finishPuzzle('Matching1')) };
		},
	});
</script>

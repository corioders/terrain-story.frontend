<template>
	<p>Rozsypanka część 2 - 5 zasad dobrego życia.</p>
...
<script lang="ts">
import { matching2 as questions } from '@help/assets/questions';
...
export default defineComponent({
	...
	setup() {
		...
		return { questions, ...questionExecutor(() => store.finishPuzzle('Matching2')) };
	},
});
</script>

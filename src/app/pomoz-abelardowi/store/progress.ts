...
export type PuzzleID = 'Bingo' | 'Emotions1' | 'Emotions2' | 'Jacobson' | 'Rebus' | 'Matching' | 'PhoneNumbers';
const puzzleIDs: PuzzleID[] = ['Bingo', 'Emotions1', 'Emotions2', 'Jacobson', 'Rebus', 'Matching', 'PhoneNumbers'];

const witnesses = [
	'Panie, jak był ten napad, to akurat w telewizji leciał stand-up Paczesia. Łysy kazał się wszystkim obrócić, tak żebyśmy nie widzieli jego twarzy, ale akurat patrzyliśmy w telewizor. To kuriozalne, ale wszyscy się śmialiśmy, bo Rafik naprawdę daje radę. Jak doszło do żartu o kurtce i rachunku za prąd, to nawet postrzelony ochroniarz się zaśmiał. A Łysy nic a nic. Jakby nie miał poczucia humoru!.',
	'Jestem sprzedawczynią w sklepie. Sprawca napadu miał kominiarkę, która szczelnie przylegała mu do twarzy, ale chyba utrudniała obserwację otoczenia. Przestępca wpadł w stanowisko z królikami, a one rozbiegły się po sklepie. To pewnie przez tę kominiarkę!.',
	...
	'A ja mam dowód! Kłębek kłaków. Urwałem tyle, że szłoby z tego zrobić cały warkocz. Państwu teraz zrobię to całe CSI i zaraz będziemy wiedzieć co i jak.',
];

const witnesses = [
	...
	'Jestem sprzedawczynią w sklepie. Sprawca napadu miał na twarzy kominiarkę, która szczelnie przylegała mu do twarzy, ale chyba utrudniała obserwację otoczenia. Przestępca wpadł w stanowisko z królikami, a one rozbiegły się po sklepie. To pewnie przez tę kominiarkę!.',
